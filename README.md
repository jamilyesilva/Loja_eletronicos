...
O **EletroSys** é um sistema web de loja virtual desenvolvido com **PHP** e **MySQL**, que simula parte do funcionamento de um e-commerce.
...
Usuários administradores possuem acesso exclusivo ao painel administrativo.
...
- Uso de **transações no banco de dados** para garantir a integridade dos pedidos  
...
- Validação automática de estoque ao adicionar ou finalizar o pedido  
...
- Finalização apenas se houver estoque disponível  
...
- Chamados vinculados ao número do pedido  
...
Este projeto tem fins **educacionais** e foi desenvolvido para consolidar conhecimentos em desenvolvimento web com PHP e banco de dados relacional.   
### By: Jamily Emanuele Da Silva
